...
urls = [
	...
	('/register', ['GET','POST'], Reg.as_view('reg_alllist')),								#- Register user to create their mockform
	('/mockapi', ['GET'], Dashboard.as_view('dashboard')),							# List all the mock API s
	...
	('/mockapi/<slug>/<version>', ['GET','POST'], ViewJson.as_view('viewmock')) 			#- View mock apis version wise
]